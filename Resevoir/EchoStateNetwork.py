...
class EchoStateNetwork : 
    ...
    def __init__( self, input_size=1, output_size=1, res_size=100,
                   leak_rate = .3, connectivity = .42  ):
        ...
        self.weights_in  = np.random.rand ( self.res_size, input_size ) - range_shift 
        self.resevoir    = Resevoir.Resevoir( self.res_size, connectivity, leak_rate )
    ...
    def train ( self, train_input, train_output ):
        ...
        states_matrix = np.zeros( (self.res_size, len(train_input)) )
        ...
        self.weights_out = OutputLayer.create ( states_matrix, train_output, self.output_size )
    ...
    def test ( self, test_input, test_truth ):
        ...
        return np.array(machine_outputs), mse
