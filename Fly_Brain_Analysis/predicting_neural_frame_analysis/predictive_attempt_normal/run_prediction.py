...
train_in        = neuron_data[train_idx][ pred_cols ]
train_out_truth = fut_brain[train_idx][ pred_cols ]
test_in         = neuron_data[test_idx][ pred_cols ]
test_out_truth  = fut_brain[test_idx][ pred_cols ]
